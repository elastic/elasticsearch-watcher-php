...
class YamlRunnerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $params['customNamespaces'] = array('watcher' => 'Watcher\WatcherNamespace');
    ...
    {
        $path = dirname(__FILE__).'/../../../util/elasticsearch-watcher/rest-api-spec/test/';
